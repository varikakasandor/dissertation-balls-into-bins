...
NMS = ((3, 5),)  # ((5, 5), (5, 10), (5, 25), (20, 20), (20, 60), (20, 400), (50, 50), (50, 200), (50, 2500))
STRATEGIES = ("dqn", "always_accept", "random", "local_reward_optimiser", "threshold", "dp")
RUNS = 25
RE_TRAIN_DQN = 5
            ...
            if strategy_name == "dqn":
                ...
                for _ in range(re_train_dqn):
                 ...
                 f'{str(datetime.now().strftime("%Y_%m_%d %H_%M_%S_%f"))}_{n}_{m}')
                    strategy = FullKnowledgeDQNStrategy(n=n, m=m, use_pre_trained=False, save_path=save_path, **hyperparameters)
                    curr_scores = run_strategy_multiple_times(n=n, m=m, runs=runs // re_train_dqn, strategy=strategy, reward=reward_fun,
