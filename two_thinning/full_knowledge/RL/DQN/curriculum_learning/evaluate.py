...
from two_thinning.full_knowledge.RL.DQN.neural_network import FullTwoThinningRecurrentNet
from two_thinning.full_knowledge.RL.DQN.curriculum_learning.train import train, evaluate_q_values_faster
...
def evaluate(trained_model, n=N, m=M, reward_fun=REWARD_FUN, eval_runs_eval=EVAL_RUNS_EVAL,
    ...
    avg_score = evaluate_q_values_faster(trained_model, n=n, m=m, reward=reward_fun, eval_runs=eval_runs_eval,
                                         threshold_change_freq=threshold_change_freq,
