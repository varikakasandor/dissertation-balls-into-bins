...
from two_thinning.full_knowledge.RL.DQN.curriculum_learning.train import train
from two_thinning.full_knowledge.RL.DQN.train import evaluate_q_values_faster
...
def compare(n=N, m=M, memory_capacity=MEMORY_CAPACITY, eps_start=EPS_START,
            ...
            target_update_freq=TARGET_UPDATE_FREQ, max_threshold=MAX_THRESHOLD, pacing_fun=PACING_FUN,
            ...
            nn_type=NN_TYPE):
    current_model = train(n=n, m=m, memory_capacity=memory_capacity, reward_fun=reward_fun,
