...
def evaluate(n=n, m=m, episodes=episodes, epsilon=epsilon, initial_value=initial_value, reward=reward, runs=runs):
    best_threshold = train(n=n, m=m, episodes=episodes, epsilon=epsilon, initial_value=initial_value, reward=reward)
