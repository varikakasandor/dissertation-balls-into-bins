...
The Markov property has to hold: the transition and reward probabilities are independent of the past, and depend only on the current state and the action executed. Using timesteps as indices \NOTE{A}{Is this clear?}, it means
...
\begin{itemize}
    ...
    I had no previous knowledge about RL, or balls-into-bins beyond related foundational courses from the Tripos \NOTE{A}{Give examples?}, so I have done extensive background reading in both. Background reading was successful, I gained a deep understanding of the balls-into-bins literature, and explored the relevant parts of RL.
