...
If I could start again, I would reduce the breadth of the project and thereby leave only a smaller amount of interesting discussion for the appendices.\NOTE{A}{Is this sentence needed?}
