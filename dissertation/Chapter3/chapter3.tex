...
\begin{itemize}
    ...
    \item It is always optimal to accept a bin with load $0$, as there is no better bin (formally, this if a corollary of Lemma~\ref{lemma: thresholdproperty}\NOTE{A}{Should I add more details? It is a bit messy to argue formally.}), so $a\geq 0$.
